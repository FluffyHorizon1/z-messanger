...
| 16 | **16.1 ✅** sealed sender now holds against the relay process, not only its stored data (`adr/0007`, R21) · 16.2 pattern study ⏳ · 16.3 federation ADR ⏳ | `anonymous_sender_test.dart`, `server/test/sealed.test.js` |
