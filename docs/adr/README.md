...
| [0009](0009-connect-without-meeting.md) | Adding a contact you cannot stand next to: a one‑time invite, a commitment round on both sides, and an eight‑digit string bound to both identities — so a remote add can end *verified* over a voice call | **Proposed** 2026‑09‑12 — ceremony built (17.1); the trust‑model half is the open question |
