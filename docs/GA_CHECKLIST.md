...
| G9 | Localization | ❌ **10 of 14 screens** |
...
to zero hardcoded literals. **10 of 14 screens are migrated; ~250
strings remain**, and no locale but English exists.

The four left are the four largest — `settings_screen.dart` (107),
`chat_screen.dart` (76), `contact_info_screen.dart` (67) — which is the usual
shape of this kind of migration: the small screens go first and the count falls
slowly at the end.
