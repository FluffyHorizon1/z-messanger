...
| `server/` | Node.js, `server.js` ~1 060 lines, ~3.4 k lines of tests (67) incl. the clean‑room vector verifier | RAM‑only relay: authenticated mailboxes, sealed‑envelope storage/delivery, push wake, metrics; two‑instance mode via Redis |
