...
def check_kt_log():
    ...
    eq(sha256(bytes.fromhex(md["device_list"]["signing_input_v2"]))[:16].hex(), first["fingerprint"], "alice v3: fp = SHA-256(v2 signing input)[0..16] (ADR 0010, since the list carries sig2)")
